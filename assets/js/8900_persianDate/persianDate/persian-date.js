...
var tarikh = new persianDate
   //result => 1400-04-18 15:32:12 PM

document.querySelector(".date").innerHTML =tarikh.toLocale('fa').format("DD")
document.querySelector(".day").innerHTML =tarikh.toLocale('fa').format("dddd")
document.querySelector(".month").innerHTML =tarikh.toLocale('fa').format("MMMM")
document.querySelector(".year").innerHTML =tarikh.toLocale('fa').format("YYYY")
